...
function CircuitField({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g stroke="#38BDF8" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" opacity="0.4">
...
const capabilities = [
  {
    ...
    description:
      "150,000+ indicators aggregated from 9 live threat feeds — C2, malware, and phishing with full context.",
    icon: (
            ...
            <div>
              ...
              <div className="space-y-4 text-white/60 text-lg">
                ...
                <p>
                  ...
                  traces and vias radiating from a green pupil — with a cyan sweep that never stops
