 ...
 * PCB traces + vias radiating from a green pupil, a cyan DNS-resolution ring,
...
export function JichoMark({
  ...
  return (
    ...
    >
      ...
      <circle cx="32" cy="32" r="16" stroke="#38BDF8" strokeWidth="1.1" strokeDasharray="9 7" opacity="0.4" />
      <circle cx="32" cy="32" r="11" stroke="#38BDF8" strokeWidth="1.1" strokeDasharray="5 5" opacity="0.6" />

      {/* radial PCB traces + vias */}
      <g stroke="#38BDF8" strokeWidth="1.2" strokeLinecap="round" opacity="0.85">
      ...
      {/* pupil */}
      <circle className="jm-pulse" cx="32" cy="32" r="16" stroke="#4ADE80" strokeWidth="1" opacity="0.28" />
      <circle cx="32" cy="32" r="5.6" fill="url(#jmPupil)" />
      <circle cx="32" cy="32" r="2" fill="#0A0E17" />
    </svg>
  );
}
