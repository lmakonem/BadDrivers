...
Configuration (edit the four constants below or override via env):
    PVE   - SSH target for the Proxmox host (root@<ip>)
    VMID  - Proxmox VM ID of the Windows 11 22H2 test VM
    EXE   - Path to cascade.exe on the guest
    DRV   - Path to BiosToolCommonDriver.sys on the guest

Certified: 5 consecutive 28/0 PASS runs on Win11 22H2 (build 22621), 2026-08-29.
"""
import subprocess, sys, json, re, base64, time, argparse

PVE   = "root@192.168.36.225"
VMID  = "126"
EXE   = r"C:\Users\Public\cascade.exe"
DRV   = r"C:\Users\Public\BiosToolCommonDriver.sys"
